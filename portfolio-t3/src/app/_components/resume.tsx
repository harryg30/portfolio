...
export default function About(): JSX.Element {
  return (
    <div className="flex flex-col px-3">
      ...
      <h1>Skills</h1>
      <p>
        JavaScript (React) | Python (Flask) | Java | Hibernate | SQL | Scala |
        RESTful APIs | TypeScript | Spark | MongoDB | HDFS | Git | Jenkins |
        Docker | Jira | CI/CD | Pip | npm | UX/UI | Airflow | HTML | CSS |
        Apache | PostMan |
      </p>
      <h1>Education</h1>
      <b>
        Bachelor of Science in Computer Science| Wentworth Institute of
        Technology, Boston, MA, 2016-2020
      </b>
      <p>
        Projects
        <ul>
          <li>
            ...
            <p>
              Calculated similarity scores using a bag of words approach
              combined with sentiment analysis between all English articles
              using Apache Spark and Facebook’s NLP model{" "}
            </p>
          </li>
          <li>
            ...
            <p>
              {" "}
              Dijkstra's, A*, bfs, dfs algorithms in a React Redux interactive
              web app.
            </p>
          </li>
        </ul>
